...
import styles from './AngularJsTodoWebPart.module.scss';
import * as strings from 'AngularJsTodoWebPartStrings';

import * as angular from 'angular';
import './app/app-module';

export interface IAngularJsTodoWebPartProps {
    hideFinishedTasks: boolean;
}

export default class AngularJsTodoWebPart extends BaseClientSideWebPart<IAngularJsTodoWebPartProps> {
    private $injector: angular.auto.IInjectorService;

    public render(): void {
        if (this.renderedOnce === false) {
            this.domElement.innerHTML = `
        <div class="${styles.angularJsTodo}">
