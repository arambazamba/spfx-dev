...
import styles from './PnPPropsWpWebPart.module.scss';
import * as strings from 'PnPPropsWpWebPartStrings';
...
export interface IPnPPropsWpWebPartProps {
...
export default class PnPPropsWpWebPart extends BaseClientSideWebPart<IPnPPropsWpWebPartProps> {
    public render(): void {
        const {
    ...
    private getDropdownInfoHeaderCalloutContent() {
