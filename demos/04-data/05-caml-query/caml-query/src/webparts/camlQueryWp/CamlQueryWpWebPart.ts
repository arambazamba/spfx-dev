...
export default class CamlQueryWpWebPart extends BaseClientSideWebPart<ICamlQueryWpWebPartProps> {
    public render(): void {
    ...
    public getNews(): Promise<NewsItem[]> {
        ...
        return new Promise<NewsItem[]>((resolve: (options: NewsItem[]) => void, reject: (error: any) => void) => {
            this.context.spHttpClient.post(restUrl, SPHttpClient.configurations.v1, options).then((response: SPHttpClientResponse) => {
